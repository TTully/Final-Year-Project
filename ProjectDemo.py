...
while(True):
    if (GPIO.input(Pir) == 0):
        IPCameraCapture = cv2.VideoCapture("rtsp://192.168.0.100:554/12") # Create a videoCapture object from RTSP stream
        ...
        output = cv2.VideoWriter('MotionDetected1.avi', fourcc, 25.0, (640, 480))
